import React, { CSSProperties, HTMLAttributeReferrerPolicy, MouseEvent } from 'react';

import { NTooltip } from '@/ui/tooltip/models';

/**
 * Неймспейс с типизацией NTypography
 */

export namespace NTypography {
  export type TBaseType = 'secondary' | 'success' | 'warning' | 'danger';
  export declare const TITLE_ELE_LIST: readonly [1, 2, 3, 4, 5];

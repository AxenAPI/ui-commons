...
import type { BaseSelectPropsWithoutPrivate } from 'rc-select';
...
export namespace NTreeSelect {
  ...
  export type TProps<TValueType = any, TOptionType extends DataNode = TTreeData> = Omit<
  ...
  > & {
     ...
     * Очистка значени
     */
    isAllowClear?: boolean | { clearIcon?: React.ReactNode };
    /**
    ...
    onPopupScroll?: () => void;
    /**
     * Максимальное количество выборки
     */
    maxCount?: number;
  };
}

...
import type { TSize, TVariant } from '@/models/ui';

/**
 * Неймспейс с типизацией NDateTime
 */

export namespace NDateTime {
  ...
  export type TTimePickerProps = {
     ...
     */
    floatLabel?: boolean;
    components?: Pick<TimePickerProps, 'components'>['components'];
  };
  ...
  export type TCommonProps = {
     ...
     */
    isDisabledDate?: (currentDate: Dayjs, info: { from?: Dayjs }) => boolean;
    isOpen?: boolean;
    isReadonly?: boolean;
    mask?: (string | RegExp)[];
    maxDate?: Dayjs;

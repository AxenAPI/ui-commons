...
/**
 * Неймспейс с типизацией NRangePicker
 */

export namespace NRangePicker {
  ...
  export type TFormat = NDateTime.TFormat;

  export type TProps = NDateTime.TCommonProps & {
    ...
    onBlur?: (event: any, range: { range?: 'start' | 'end' }) => void;
    /**
     * FIXME: ???
     */
    onCalendarChange?: (
      dates: TNoUndefinedRangeValueType<Dayjs>,
    ...
    onFocus?: (event: any, range: { range?: 'start' | 'end' }) => void;

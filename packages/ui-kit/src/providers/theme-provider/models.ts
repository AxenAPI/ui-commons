...
export type TExtendedThemeConfig = {
  components?: Partial<ThemeConfig['components']> & {
    ...
    ScrollArea?: {
      scrollThumbWidth?: string;
      scrollThumbColor?: string;
      scrollThumbColorHover?: string;
      scrollThumbColorActive?: string;
      scrollThumbPadding?: number | string;
    };
  };
} & ThemeConfig;
...
export type TComponents = keyof NonNullable<TExtendedThemeConfig['components']>;
